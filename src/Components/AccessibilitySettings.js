...
const AccessibilityIcon = () => {
  ...
  const toggleMenu = () => {
    ...
    const adjustLineHeight = (increment) => {
    ...
    const adjustLetterSpacing = (increment) => {
    ...
    const enableDyslexicFont = () => {
        // Implement enableDyslexicFont logic here
    };

    const enableHighlightHeadings = (load=false) => {
    ...
    const enableHighlightLinks = (load=false) => {
    ...
    const adjustFontWeight = (increment=100) => {
    ...
    const enableBigCursor = (load=false) => {
    ...
    const adjustContrast = (load=false) => {
    ...
    <div className="asw-widget">
        <div className="accessibility-icon" onClick={toggleMenu}></div>
    </div>
    </div>
    <div className={`asw-menu ${menuOpen ? 'open' : ''}`} style={{ display: 'none' }} id="aswMenu">
                  <div className="asw-menu-header">
                      <div className="asw-translate">
                          Accessibility Menu
                      </div>
                      <div>
                          <div role="button" className="asw-menu-reset" title="Reset settings" onClick={resetSettings}>
                              <span className="material-icons">restart_alt</span>
                          </div>
                          <div role="button" className="asw-menu-close" title="Close" onClick={toggleMenu}>
              ...
              <link href="https://fonts.googleapis.com/icon?family=Material+Icons&amp;text=ads_click,text_rotation_none,text_fields,format_size,blind,restart_alt,close,link,local_parking,contrast,spellcheck,local_library,format_bold,format_line_spacing" rel="stylesheet"></link>
              </>
      );
};
