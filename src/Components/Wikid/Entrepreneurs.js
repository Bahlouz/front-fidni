...
// Function to check if the description contains the <entrepreneur> tag
...
const Entrepreneurs = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Filter items based on subcategory 'WikiPhédia' and the presence of <entrepreneur> tag in description
    ...
    const combinedItems = [...Entrepreneursitems, ...apiItems];
            ...
            <div className="background-image-entrepreneurs">
                <div className="overlay-text-entrepreneurs">
                    ...
                    <p className="p-5 entrepreneurs-description">
                        Découvrez des profils détaillés d'entrepreneurs innovants, explorez leurs projets, réalisations et contributions dans le monde des affaires. Informez-vous sur leurs contributions significatives à l'économie et à l'innovation.
                    </p>
                </div>
